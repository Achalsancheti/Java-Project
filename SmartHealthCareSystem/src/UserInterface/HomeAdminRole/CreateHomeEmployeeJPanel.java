 ...
 */
public class CreateHomeEmployeeJPanel extends javax.swing.JPanel {
    
    private OrganizationDirectory organizationDirectory;
    private JPanel userProcessContainer;
    private ManageHomeEmployeeJPanel mejp;
     ...
     */
    public CreateHomeEmployeeJPanel(JPanel userProcessContainer,OrganizationDirectory organizationDirectory,ManageHomeEmployeeJPanel mejp) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(organizationEmpComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 140, 270, 35));
        ...
        add(createemployeeButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 380, 110, 35));
        ...
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 60, -1, -1));
    ...
    private void createemployeeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createemployeeButtonActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Person Has Been Created Successfully","Success",JOptionPane.PLAIN_MESSAGE);
        nameTextField.setText("");
        mejp.populateTable(organization);
        }
        else{
        JOptionPane.showMessageDialog(null, "Please Enter The Name and Age","Erroe",JOptionPane.ERROR_MESSAGE);
        }
