 ...
 */
public class HomeAdminWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public HomeAdminWorkAreaJPanel(JPanel userProcessContainer, Enterprise enterprise,MainUserAccount userAccount,EcoSystem business) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Admin.jpg"))); // NOI18N
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 130, -1, -1));
    ...
    private void manageuseraccountButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageuseraccountButtonActionPerformed
        ...
        ManageHomeUserAccountJPanel muajp = new ManageHomeUserAccountJPanel(userProcessContainer, enterprise,business);
        userProcessContainer.add("ManageFactoryUserAccountJPanel", muajp);
    ...
    private void manageemployeeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageemployeeButtonActionPerformed
        ...
        ManageHomeEmployeeJPanel mejp = new ManageHomeEmployeeJPanel(userProcessContainer, enterprise.getOrganizationDirectory(),userAccount,business);
        userProcessContainer.add("ManageFactoryEmployeeJPanel", mejp);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    ...
    private void manageorganizationButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageorganizationButtonActionPerformed
        ...
        ManageHomeOrganizationJPanel mojp = new ManageHomeOrganizationJPanel(userProcessContainer, enterprise.getOrganizationDirectory());
        userProcessContainer.add("ManageFactoryOrganizationJPanel",mojp);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
